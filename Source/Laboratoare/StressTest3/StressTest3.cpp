...
void StressTest3::Init()
{
	{
		Shader* shader = new Shader("ShaderTema");
		shader->AddShader("Source/Laboratoare/StressTest3/Shaders/VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader("Source/Laboratoare/StressTest3/Shaders/FragmentShader.glsl", GL_FRAGMENT_SHADER);
...
void StressTest3::Update(float deltaTimeSeconds)
{
	glLineWidth(3);
	glPointSize(5);
...
void StressTest3::FrameEnd()
{
	DrawCoordinatSystem();
}

bool StressTest3::coordsAreNotValid(glm::vec3 pos)
{
	for (Item* it : cuburi) {
...
glm::vec3 StressTest3::GetCoords()
{
	glm::vec3 coords;
...
glm::vec3 StressTest3::ApplyRandomForce()
{
	glm::vec3 force;
	force.x = (rand() % 2 - 1) * 5;
	force.y = (rand() % 2 - 1) * 7;
...
void StressTest3::AddCub(glm::vec3 pos, glm::vec3 force)
{
...
void StressTest3::AddSfera(glm::vec3 pos, glm::vec3 force)
{
...
void StressTest3::AddCilindru(glm::vec3 pos, glm::vec3 force)
{
...
void StressTest3::OnInputUpdate(float deltaTime, int mods)
{

}

void StressTest3::OnKeyPress(int key, int mods)
{
	if (key == GLFW_KEY_P)
	{
		AddCub(GetCoords(), ApplyRandomForce());
...
void StressTest3::OnKeyRelease(int key, int mods)
{
	// add key release event
}

void StressTest3::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
	// add mouse move event
}

void StressTest3::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
	// add mouse button press event
}

void StressTest3::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
	// add mouse button release event
}

void StressTest3::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}

void StressTest3::OnWindowResize(int width, int height)
{
}

void StressTest3::renderCuburi(float deltaTimeSeconds) {
	for (Item* it : cuburi) {
		//verifica coliziuni
...
void StressTest3::renderSfere(float deltaTimeSeconds)
{
	for (Item* it : sfere) {
		//verifica coliziuni
		//schimba pozitia curenta bazat pe forte
...
void StressTest3::renderCilindri(float deltaTimeSeconds)
{
	for (Item* it : cilindri) {
		//verifica coliziuni
		//schimba pozitia curenta bazat pe forte
...
void StressTest3::isCollided(Item* it)
{
...
void StressTest3::checkCollision(float deltaTimeSeconds)
{
...
int StressTest3::fataLovita(Item* object, Item* obstacle, float deltaTimeSeconds)
{
...
int StressTest3::whereCollided(Item* object, Item* obstacle)
{
	float planZ = object->pozitiaCurenta.z - obstacle->pozitiaCurenta.z;
